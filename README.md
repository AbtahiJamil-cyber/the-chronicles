...
<body>
  ...
  <div class="footer">
    <p>&copy; 2025 The Chronicles.আবতাহি বিন জামিল এর দারা তৈরি,সর্বস্বত্ব সংরক্ষিত।</p>
  </div>
...
<section id="travel-journey" style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border-radius: 10px;">
  ...
  <ul style="list-style-type: square; margin-left: 20px; color: #27ae60;">
    ...
    <li>5.আমরা অদের ফেসবুক,ইন্সটাগ্রাম,হ্যাক করতে চাই।সাইবার সিকিউরিটির মাধ্যমে এবং তাদের যত তথ্য পাওয়া যায় সব কিছু বের করে ফাস করে দিবো।</li>
    <li>6।আমাদের দলের প্রত্যেকটা প্রতিবেদন,জরিমানা এগুলা গোপন ইনফর্মেশন।</li>
    <li>7.দলের নিয়ম নিতি গোপন ইনফর্মেশন</li>
